[README.md](https://github.com/user-attachments/files/28223733/README.md)<!-- HEADER -->
<div align="center">
...
> ⚙️ *To enable the snake: go to your repo Actions tab and set up the [GitHub Snake workflow](https://github.com/Platane/snk)*
